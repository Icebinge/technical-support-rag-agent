...
Stage94 should confirm and freeze the train/dev-only protocol for
`score_margin_bm25_normalization_gate_design`. The frozen test split remains
...
thresholds, and runtime defaults remain unchanged.
