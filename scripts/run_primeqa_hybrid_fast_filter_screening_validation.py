...
app = typer.Typer(
    help="Run Stage121 PrimeQA hybrid fast-filter screening train-CV/dev validation."
)
...
def main(
    ...
    output: Annotated[
        Path | None,
        typer.Option("--output", help="Output Stage121 validation JSON path."),
    ] = None,
    ...
    user_confirmed_validation: Annotated[
        ...
        typer.Option(
            ...
            help="Required confirmation for Stage121 train-CV/dev validation.",
        ),
    ] = False,
    ...
    """Write the Stage121 train-CV/dev fast-filter screening validation report."""
    ...
    visualization_output_dir = visualization_dir or (
        settings.artifact_dir
        / "primeqa_hybrid_fast_filter_screening_validation_stage121_visuals"
    )
    ...
    typer.echo(f"Saved PrimeQA hybrid Stage121 screening validation: {output_path}")
