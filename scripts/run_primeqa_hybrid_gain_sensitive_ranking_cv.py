...
app = typer.Typer(help="Run the Stage 188 train-only gain-sensitive nested CV.")
...
def main(
    ...
    report = analysis.run_stage188_gain_sensitive_ranking_cv(
    ...
    visualizations = analysis.write_stage188_visualizations(
        ...
        or artifacts / "primeqa_hybrid_gain_sensitive_ranking_stage188_visuals",
    )
    report = {
        **report,
        "visualizations": [
    ...
    output_path = output or artifacts / "primeqa_hybrid_gain_sensitive_ranking_stage188.json"
    ...
    typer.echo(f"Saved Stage 188 report: {output_path}")
