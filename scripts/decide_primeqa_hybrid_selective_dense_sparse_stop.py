...
app = typer.Typer(
    help="Write Stage99 PrimeQA hybrid selective dense+sparse stop decision."
)
...
def main(
    ...
    stage97_report: Annotated[
        Path | None,
        typer.Option("--stage97-report", help="Stage97 frozen protocol JSON."),
    ] = None,
    stage98_report: Annotated[
        Path | None,
        typer.Option("--stage98-report", help="Stage98 comparison JSON."),
    ] = None,
    output: Annotated[
        Path | None,
        typer.Option("--output", help="Output Stage99 stop decision JSON path."),
    ] = None,
    ...
    user_confirmed_stop: Annotated[
        ...
        typer.Option(
            ...
            help="Required confirmation for stopping the selective dense+sparse route.",
        ),
    ] = False,
    ...
    """Write Stage99 selective dense+sparse stop decision from public-safe reports."""
    ...
    stage98_report_path = stage98_report or (
        settings.artifact_dir
    ...
    visualization_output_dir = visualization_dir or (
        settings.artifact_dir
        / "primeqa_hybrid_selective_dense_sparse_stop_decision_stage99_visuals"
    )
    ...
    report = decide_primeqa_hybrid_selective_dense_sparse_stop(
        ...
        stage98_report_path=stage98_report_path,
    ...
    typer.echo(f"Saved PrimeQA selective dense+sparse stop decision: {output_path}")
...
def _console_summary(report: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "second_wave_route_status": report["second_wave_route_status"],
