...
app = typer.Typer(help="Run the Stage 186 train-only joint-constraint nested CV.")
...
def main(
    ...
    report = analysis.run_stage186_joint_constraint_ranking_cv(
        stage185_protocol_path=artifacts
    ...
    visualizations = analysis.write_stage186_visualizations(
        ...
        or artifacts / "primeqa_hybrid_joint_constraint_ranking_stage186_visuals",
    )
    report = {
        **report,
        "visualizations": [
    ...
    output_path = output or artifacts / "primeqa_hybrid_joint_constraint_ranking_stage186.json"
    ...
    typer.echo(f"Saved Stage 186 report: {output_path}")
