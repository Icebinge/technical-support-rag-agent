...
app = typer.Typer(help="Freeze the Stage 185 joint citation/F1 ranking protocol.")
...
def main(
    ...
    visualizations = protocol.write_stage185_visualizations(
        ...
        or artifacts / "primeqa_hybrid_joint_constraint_ranking_protocol_stage185_visuals",
    )
    report = {
        **report,
        "visualizations": [
    ...
    output_path = (
        output or artifacts / "primeqa_hybrid_joint_constraint_ranking_protocol_stage185.json"
    )
    ...
    typer.echo(f"Saved Stage 185 protocol: {output_path}")
