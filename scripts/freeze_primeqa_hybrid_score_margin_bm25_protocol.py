...
app = typer.Typer(help="Freeze Stage94 PrimeQA hybrid score-margin BM25 protocol.")
...
def main(
    ...
    stage93_report: Annotated[
        Path | None,
        typer.Option("--stage93-report", help="Stage93 stop decision JSON."),
    ] = None,
    output: Annotated[
        Path | None,
        typer.Option("--output", help="Output Stage94 protocol report JSON path."),
    ] = None,
    ...
    user_confirmed_candidate: Annotated[
        ...
        typer.Option(
            ...
            help="Required confirmation for the Stage93 next candidate.",
        ),
    ] = False,
    confirmed_candidate_id: Annotated[
        str,
        typer.Option("--confirmed-candidate-id", help="Confirmed Stage93 candidate id."),
    ...
    """Write Stage94 score-margin BM25 protocol freeze report."""
    ...
    typer.echo(f"Saved PrimeQA hybrid score-margin BM25 protocol report: {output_path}")
