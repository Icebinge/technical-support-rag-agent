...
app = typer.Typer(help="Evaluate offline document/citation-aware guard designs.")
...
def main(
    ...
    stage41_report: Annotated[
        Path,
        typer.Option("--stage41-report", help="Stage 41 changed-case audit JSON."),
    ],
    model: Annotated[
        str,
    ...
    output: Annotated[
        Path | None,
        typer.Option("--output", help="Output Stage 42 guard-design JSON path."),
    ] = None,
    ...
    """Run Stage 42 document/citation-aware holdout guard design."""

    _ensure_file_exists(dataset)
    _ensure_file_exists(stage41_report)
    ...
    result_dict["source_paths"] = {
        "dataset": str(dataset),
        "stage41_report": str(stage41_report),
