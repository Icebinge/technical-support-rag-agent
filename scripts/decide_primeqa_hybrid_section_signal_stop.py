...
app = typer.Typer(help="Write Stage93 PrimeQA hybrid section-signal stop decision.")
...
def main(
    ...
    stage92_report: Annotated[
        Path | None,
        typer.Option("--stage92-report", help="Stage92 section signal comparison JSON."),
    ] = None,
    output: Annotated[
        Path | None,
        typer.Option("--output", help="Output Stage93 stop decision JSON path."),
    ] = None,
    ...
    user_confirmed_stop: Annotated[
        ...
        typer.Option(
            ...
            help="Required confirmation for stopping the section-signal route.",
        ),
    ] = False,
    ...
    """Write Stage93 section signal stop decision from public-safe reports."""
    ...
    stage92_report_path = stage92_report or (
        settings.artifact_dir
        / "primeqa_hybrid_section_signal_comparison_stage92.json"
    )
    ...
    visualization_output_dir = visualization_dir or (
        settings.artifact_dir
        / "primeqa_hybrid_section_signal_stop_decision_stage93_visuals"
    )

    report = decide_primeqa_hybrid_section_signal_stop(
        stage84_report_path=stage84_report_path,
        stage92_report_path=stage92_report_path,
    ...
    typer.echo(f"Saved PrimeQA hybrid section signal stop decision: {output_path}")
